            ...
            <div class="px-4 sm:px-0 lg:px-4 pb-4 bg-gray-900 rounded-lg">
              ...
              >
                <div class="flex flex-items-center justify-center rounded-full">
                  <UserAvatar
                    :photoURL="config.image"
                    :name="config.name"
                    class="w-12 h-12 border-2 border-yellow-600 hover:border-hot-pink -mt-5 bg-gray-900 rounded-full"
                  />
                </div>
              </a>
              <header class="py-4">
                <div class="space-y-1 text-center">
                  <div>
                    <h1 class="text-2xl font-extrabold text-gray-100 tracking-tight">
                      post title
                    </h1>
                  </div>
