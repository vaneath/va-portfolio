          ...
          <div data-aos="zoom-in" class="lg:grid lg:grid-cols-12">
            ...
            >
              <div>
                ...
                >
                  <span class="md:block">Everything I like</span>
                  <!-- <div>
                    <vue-typer :text="$t('hero.words')"></vue-typer>
                  </div> -->
                </h1>
                <p class="mt-3 text-base text-gray-300 sm:mt-5">
                  Hi, I'm Vaneath. I'm a software engineer and a tech enthusiast.
                </p>
                <!-- <p
...
<style scoped>
.vue-typer :deep(.custom.char) {
  @apply text-indigo-600;
}

.vue-typer :deep(.custom.char.selected) {
  @apply bg-indigo-600 text-white;
}

.vue-typer :deep(.custom.caret) {
  width: 5px;
  @apply bg-indigo-600;
}
